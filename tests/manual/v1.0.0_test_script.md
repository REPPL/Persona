...
data_dir = Path('tests/synthetic')
assert data_dir.exists(), 'tests/synthetic/ should exist'
...
persona cost --from tests/synthetic/interviews/ --count 3 --provider anthropic
