...
**Expected:** Shows Persona version, Python version, lists configured providers with status, and overall status indicator
...
**Command:**
```bash
persona experiment create test-manual-v010
```

**Expected:** Creates experiments/test-manual-v010/ directory with config.yaml inside, displays success message
...
**Expected:** Shows table with experiment names including test-manual-v010
...
**Command:**
```bash
persona experiment show test-manual-v010
```

**Expected:** Shows experiment configuration, provider/model settings, and creation timestamp
...
**Expected:** Processes CSV file, generates personas using mock LLM, creates timestamped output directory with JSON/Markdown personas
...
**Expected:** API call succeeds, real personas generated, cost recorded in metadata
...
**Expected:** Shows token count estimate and cost estimate, does NOT call LLM API
...
**Command:**
```bash
persona experiment delete test-manual-v010
```

**Expected:** Prompts for confirmation, deletes experiment directory, shows success message
...
**Expected:** Clear error message about missing path, suggests possible corrections, non-zero exit code
...
**Expected:** Clear authentication error message, suggests checking API key configuration, non-zero exit code
...
persona experiment create --help
```
