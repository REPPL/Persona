# Milestone: v1.2.0 - TUI Dashboard

Full-screen terminal user interface for monitoring and managing persona generation.

## Goal

Provide a rich, full-screen terminal dashboard using Textual for real-time monitoring of generation progress, experiment management, and persona browsing—all without leaving the terminal.

## Theme

**"See Everything"** - Visual monitoring and management in the terminal.
