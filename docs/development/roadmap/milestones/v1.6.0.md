...
|----|---------|----------|--------|
| [F-117](../features/planned/F-117-academic-validation-metrics.md) | Academic Validation Metrics | Quality | 📋 Planned |
| [F-118](../features/planned/F-118-hallucination-detection.md) | Hallucination Detection | Quality | 📋 Planned |

## Success Criteria

- [ ] `persona validate --academic` runs all four Shin et al. metrics
- [ ] ROUGE-L, BERTScore, GPT-similarity, G-eval implemented
- [ ] BERTScore achieves > 0.8 for high-quality personas
- [ ] Persona Perception Scale survey template exportable
- [ ] Automatic claim extraction from persona attributes
- [ ] Faithfulness score = (supported claims) / (total claims)
- [ ] HHEM classifier provides free, local hallucination detection
- [ ] Test coverage >= 90%
...
- [F-117: Academic Validation Metrics](../features/planned/F-117-academic-validation-metrics.md)
- [F-118: Hallucination Detection](../features/planned/F-118-hallucination-detection.md)
