...
## Features (0 of 1 Complete)

| ID | Feature | Category | Status |
|----|---------|----------|--------|
| [F-116](../features/planned/F-116-hybrid-local-frontier-pipeline.md) | Hybrid Local/Frontier Pipeline | Optimisation | 📋 Planned |
...
- [F-116: Hybrid Local/Frontier Pipeline](../features/planned/F-116-hybrid-local-frontier-pipeline.md)
