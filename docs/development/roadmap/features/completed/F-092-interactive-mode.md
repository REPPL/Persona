...
- [x] Add `--interactive` / `-i` global flag to Typer app
- [x] Create `src/persona/ui/interactive.py` module
- [x] Implement interactive workflow for `generate` command
- [x] Implement interactive workflow for `experiment create` command
- [x] Implement interactive workflow for `config` command
- [x] Add TTY detection (skip interactive in pipes)
- [x] Add questionary to dependencies
- [x] Write unit tests for interactive prompts
- [x] Document interactive mode in help text

## Success Criteria

- [x] `persona generate -i` launches interactive wizard
- [x] Arrow keys navigate selection menus
- [x] Tab completes file paths
- [x] Non-TTY environments skip interactive prompts
- [x] Flags override interactive choices
- [x] Test coverage ≥ 80%
