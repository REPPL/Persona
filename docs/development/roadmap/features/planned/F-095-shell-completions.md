...
- [ ] Enable Typer's completion generation
- [ ] Create installation command: `persona --install-completion`
- [ ] Add custom completer for `--provider` (anthropic, openai, gemini)
- [ ] Add custom completer for `--model` (dynamic per provider)
- [ ] Add custom completer for `--format` (json, markdown, yaml)
- [ ] Add file path completion for `--from` argument
- [ ] Test completions in bash, zsh, fish
- [ ] Document shell completion setup
- [ ] Add completion to installation guide

## Success Criteria

- [ ] Tab completes command names
- [ ] Tab completes option flags
- [ ] Tab completes known option values
- [ ] File paths complete for data arguments
...
- [F-008: CLI Interface](../completed/F-008-cli-interface.md)
